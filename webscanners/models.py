...
class zap_spider_db(models.Model):
    spider_url = models.TextField(null=True, blank=True)
    spider_scanid = models.TextField(null=True, blank=True)
    urls_num = models.TextField(null=True, blank=True)
    username = models.CharField(max_length=256, null=True)


class zap_scans_db(models.Model):
    scan_url = models.URLField(null=True, blank=True)
    scan_scanid = models.TextField(null=True, blank=True)
    rescan_id = models.TextField(blank=True, null=True)
    vul_num = models.TextField(null=True, blank=True)
    vul_status = models.TextField(null=True, blank=True)
...
class zap_spider_results(models.Model):
    spider_id = models.TextField(null=True, blank=True)
    spider_urls = models.TextField(null=True, blank=True)
    username = models.CharField(max_length=256, null=True)


class zap_scan_results_db(models.Model):
    vuln_id = models.TextField(null=True, blank=True)
    scan_id = models.TextField(null=True, blank=True)
    rescan_id = models.TextField(blank=True, null=True)
    confidence = models.TextField(null=True, blank=True)
    wascid = models.TextField(null=True, blank=True)
    cweid = models.TextField(null=True, blank=True)
    ...
    sourceid = models.TextField(null=True, blank=True)
    pluginId = models.TextField(null=True, blank=True)
    ...
    req_res = models.TextField(null=True, blank=True)
    project_id = models.TextField(null=True, blank=True)
    vuln_color = models.TextField(null=True, blank=True)
    rescan = models.TextField(blank=True, null=True)
    note = models.TextField(null=True, blank=True)
    rtt = models.TextField(null=True, blank=True)
    tags = models.TextField(null=True, blank=True)
    timestamp = models.TextField(null=True, blank=True)
    responseHeader = models.TextField(null=True, blank=True)
    requestBody = models.TextField(null=True, blank=True)
    responseBody = models.TextField(null=True, blank=True)
    requestHeader = models.TextField(null=True, blank=True)
    cookieParams = models.TextField(null=True, blank=True)
    res_type = models.TextField(null=True, blank=True)
    res_id = models.TextField(null=True, blank=True)
    date_time = models.DateTimeField(null=True)
...
class excluded_db(models.Model):
    exclude_url = models.TextField(null=True, blank=True)
    username = models.CharField(max_length=256, null=True)
...
class burp_scan_db(models.Model):
    ...
    rescan_id = models.TextField(blank=True, null=True)
    scan_date = models.TextField(null=True, blank=True)
    scan_status = models.TextField(null=True, blank=True)
...
class web_scan_db(models.Model):
    ...
    scan_status = models.TextField(null=True, blank=True)
    project_id = models.UUIDField(null=True, blank=True)
    total_vul = models.IntegerField(null=True, blank=True)
    high_vul = models.IntegerField(null=True, blank=True)
    medium_vul = models.IntegerField(null=True, blank=True)
    low_vul = models.IntegerField(null=True, blank=True)
    info_vuln = models.IntegerField(null=True, blank=True)
    scanner = models.TextField(null=True, blank=True)
    username = models.CharField(max_length=256, null=True)


class email_config_db(models.Model):
    email_id_from = models.EmailField(null=True, blank=True)
    email_subject = models.TextField(null=True, blank=True)
    email_message = models.TextField(null=True, blank=True)
    email_id_to = models.EmailField(null=True, blank=True)
    username = models.CharField(max_length=256, null=True)
...
class arachni_scan_result_db(models.Model):
    ...
    name = models.TextField(null=True, blank=True)
    description = models.TextField(null=True, blank=True)
    remedy_guidance = models.TextField(null=True, blank=True)
    ...
    ref_key = models.TextField(null=True, blank=True)
    ref_value = models.TextField(null=True, blank=True)
    vector_input_key = models.TextField(null=True, blank=True)
    vector_input_values = models.TextField(null=True, blank=True)
    vector_source_key = models.TextField(null=True, blank=True)
    vector_source_values = models.TextField(null=True, blank=True)
    page_body_data = models.TextField(null=True, blank=True)
    request_url = models.TextField(null=True, blank=True)
    request_method = models.TextField(null=True, blank=True)
    request_raw = models.TextField(null=True, blank=True)
    response_ip = models.TextField(null=True, blank=True)
    response_raw_headers = models.TextField(null=True, blank=True)
    jira_ticket = models.TextField(null=True, blank=True)
    vuln_status = models.TextField(null=True, blank=True)
    dup_hash = models.TextField(null=True, blank=True)
    vuln_duplicate = models.TextField(null=True, blank=True)
